    ...
    static save(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const imgPath = yield admin_changeUserAvatar_service_1.AdminChangeUserAvatarService.save(userId, `${process.env.SERVER_URL}/${avatarUrl}`);
...
//# sourceMappingURL=admin-changeUserAvatar-controller.js.map